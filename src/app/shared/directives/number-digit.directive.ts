...
@Directive({
  selector: 'input[appNumberDigitInput]',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => NumberDigitDirective),
      multi: true
    }
  ],
  exportAs: 'appNumberDigitInput'
})
export class NumberDigitDirective implements ControlValueAccessor, OnChanges {
